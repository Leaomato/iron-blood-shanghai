...
export const endings: Ending[] = [
    ...
    },
    {
        id: 'E_02',
        title: '空',
        body: '军需官站在你面前，双手空空。\n\n"没有了。"\n\n没有子弹。没有绷带。没有粮食。一个叫王守义的伤兵今天早上咬着木棍死去，因为止痛药三天前就用完了。他疼了七十二个小时。\n\n你本可以早点撤退。你本可以少打一场仗。\n\n可你没有。',
        conditions: [
    ...
    },
    {
        id: 'E_03',
        title: '默',
        body: '日内瓦的电报间沉默了。\n\n你的代表在走廊里截住一个英国人。"我们死了二十万人。""是的，很遗憾。"英国人整理了一下袖口，"但我们的利益……"\n\n他没说完。他不需要说完。\n\n你曾经相信国际正义。现在你知道了：没有人替穷人说话，除非穷人的血溅到他们的鞋上。\n\n你的血溅到他们的窗帘上，但窗帘可以换一块新的。',
        conditions: [
    ...
    },
    {
        id: 'E_04',
        title: '散',
        body: '第一批逃兵出现在凌晨三点。\n\n没有人追。没有人喊。就像一滴墨落进水里，看着它扩散，然后染黑整杯水。天亮的时候防线上只剩一半人。中午四分之一。\n\n你的参谋跪在地上痛哭。"他们不是懦夫！他们扛了三个月了！是我们没有给够他们子弹、吃的、希望……"\n\n他没有说"是你"。但你听见了。',
        conditions: [
    ...
    },
    {
        id: 'E_07',
        title: '撤',
        body: '命令在凌晨三点下达。很短，十三个字：全线撤退，保存实力，向南京靠拢。\n\n你最后站在地图前，看了一眼上海。三个月前你发誓要守住这里。三个月后你签字放弃它。\n\n但你没有全输。你的部队还剩两万。你的弹药还够打三场仗。你的德国顾问还在。\n\n这不是胜利。这是喘息。你用二十万条命换来几十天的喘息。\n\n够吗？不够。\n\n但这是你唯一能做的了。',
        conditions: [
    ...
    },
    {
        id: 'E_09',
        title: '舰',
        body: '帕奈号沉了。美国人死了。华盛顿炸锅了。\n\n这不是正义觉醒，这是利益边界被触碰。美国人不在乎你死多少人，但他们在乎自己死几个。\n\n突然之间那些沉默的门打开了。钱开始流进来，武器开始流进来，谴责开始对准东京。\n\n你用别人的血换来了自己的筹码。这很可耻。但你没有别的办法。\n\n弱者的正义永远需要强者的利益来买单。',
        conditions: [
